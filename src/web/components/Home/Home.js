    ...
    {/*
      ...
      <Row className="pt-5">
        ...
        <Col xs="12" sm="9" lg="5" className="pt-4 pt-sm-0">
          <h3>I can help</h3>
          <p>This repo is a great place to start, but if you'd prefer to sit back and have your new project built for you, <Link link target="_blank" rel="noopener noreferrer" href="https://mcnam.ee">get in touch with me directly</Link> and I'll provide a quote.</p>
        </Col>
      </Row>
    */}
  </TemplateContainer>
